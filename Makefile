...
.PHONY: sim sim-rw sim-nack sim-target sim-daa sim-ccc sim-direct-ccc-write sim-direct-ccc-read sim-setdasa sim-getpid sim-getbcrdcr sim-getstatus sim-entdaa sim-entdaa-multi sim-entdaa-stress sim-scheduler sim-ctrl-top-service sim-five-target-sampling-system sim-fpga-test-system sim-event-policy-ccc sim-reset-status-policy sim-recovery-sequence sim-wave1-ccc sim-wave3-activity-group test clean

sim: test

test: sim-rw sim-nack sim-target sim-daa sim-ccc sim-direct-ccc-write sim-direct-ccc-read sim-setdasa sim-getpid sim-getbcrdcr sim-getstatus sim-entdaa sim-entdaa-multi sim-entdaa-stress sim-scheduler sim-ctrl-top-service sim-five-target-sampling-system sim-fpga-test-system sim-event-policy-ccc sim-reset-status-policy sim-recovery-sequence sim-wave1-ccc sim-wave3-activity-group
